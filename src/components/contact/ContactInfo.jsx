...
const ContactInfo = () => {
  return (
    <div className="space-y-6">
      <GlassCard variant="default" className="p-6" hover={false}>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-brand-sage text-sm">{CONTACT_INFO.hours}</p>
            </div>
          </div>
      ...
      <GlassCard variant="default" className="p-6" hover={false}>
        <h3 className="text-white font-semibold mb-4">Échanger avec un conseiller</h3>
        <Button 
          variant="green" 
          size="lg" 
          className="w-full"
